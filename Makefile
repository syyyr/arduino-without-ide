...
out.bin: main.cpp core.a
	...
	avr-g++ -std=c++17 -I /usr/avr/include -I /usr/share/arduino/hardware/archlinux-arduino/avr/cores/arduino -I /usr/share/arduino/hardware/archlinux-arduino/avr/variants/standard -DF_CPU=16000000 -mmcu=atmega328p -Os -Wl,--gc-sections -ffunction-sections  -fdata-sections main.cpp core.a -o out.bin
	avr-strip out.bin
